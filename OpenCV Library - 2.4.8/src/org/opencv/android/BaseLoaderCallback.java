	...
	public void onManagerConnected(int status)
    {
        switch (status)
        {
            ...
            case LoaderCallbackInterface.MARKET_ERROR:
            {
                ...
                MarketErrorMessage.setButton(DialogInterface.BUTTON_POSITIVE, "OK", new OnClickListener() {
                    @Override
            ...
            case LoaderCallbackInterface.INCOMPATIBLE_MANAGER_VERSION:
            {
                ...
                IncomatibilityMessage.setButton(DialogInterface.BUTTON_POSITIVE, "OK", new OnClickListener() {
                    @Override
					public void onClick(DialogInterface dialog, int which) {
                        finish();
                    }
            ...
            default:
            {
                ...
                InitFailedDialog.setButton(DialogInterface.BUTTON_POSITIVE, "OK", new OnClickListener() {
	...
	public void onPackageInstall(final int operation, final InstallCallbackInterface callback)
    {
        switch (operation)
        {
            case InstallCallbackInterface.NEW_INSTALLATION:
            {
                ...
                InstallMessage.setButton(DialogInterface.BUTTON_POSITIVE, "Yes", new OnClickListener()
                {
                    @Override
					public void onClick(DialogInterface dialog, int which)
                    {
                ...
                InstallMessage.setButton(DialogInterface.BUTTON_NEGATIVE, "No", new OnClickListener() {
            ...
            case InstallCallbackInterface.INSTALLATION_PROGRESS:
            {
                ...
                WaitMessage.setButton(DialogInterface.BUTTON_POSITIVE, "Wait", new OnClickListener() {
                    @Override
					public void onClick(DialogInterface dialog, int which) {
                        callback.wait_install();
                    }
                });
                WaitMessage.setButton(DialogInterface.BUTTON_NEGATIVE, "Exit", new OnClickListener() {
                    @Override
					public void onClick(DialogInterface dialog, int which) {
                        callback.cancel();
                    }
