            ...
            public void onClick(View v) 
            {
				if(buttonPushedCounter==0)
            	{
					...
					try 
					{
				        ...
				        int h=profile.videoFrameHeight/4;
				        int w=profile.videoFrameWidth/4;
				        parameters.setPreviewSize(profile.videoFrameWidth/2,profile.videoFrameHeight/2);
